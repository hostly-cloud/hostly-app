/**
 * Persistencia histórica del catálogo de venta en localStorage.
 *
 * Firestore es la fuente operativa canónica. Este módulo se conserva
 * temporalmente para migración/archivo y consumidores legacy pendientes.
