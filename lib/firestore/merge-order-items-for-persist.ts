...
/**
 * Líneas que pueden pasar por upsert de borrador (`markSent: false`).
 * Excluye enviadas / preparación / servidas / canceladas para no provocar
 * `LINE_STATE_CONFLICT` al incluir lineIds ya autoritativos en producción.
 */
