...
export const OPERATIONAL_ELEMENT_CATALOG: readonly OperationalElementCatalogItem[] =
  [
    ...
    },
    {
      ...
      icon: "▣",
      label: "Recepción",
      description: "Punto operativo fijo para recibir clientes o gestionar acceso.",
      defaultCapacity: 0,
      color: "#3f5f72",
      supportsReservations: false,
      supportsTpv: false,
      supportsCleaning: true,
      supportsInventory: false,
      workspaceHint: "Haz clic sobre el plano para colocar una recepción.",
    },
    {
      type: "WAITER_STATION",
      icon: "▤",
      label: "Estación de camareros",
      description: "Zona de apoyo para servicio, cubertería o preparación de sala.",
      defaultCapacity: 0,
      color: "#52616f",
      supportsReservations: false,
      supportsTpv: false,
      supportsCleaning: true,
      supportsInventory: false,
      workspaceHint: "Haz clic sobre el plano para colocar una estación de camareros.",
    },
    {
      type: "SOFA",
      icon: "🛋️",
    ...
    },
    {
      ...
      description: "Zona fija de recogida para take away o delivery.",
      defaultCapacity: 0,
      color: "#64748b",
      supportsReservations: false,
      supportsTpv: false,
