...
const CONFIG_SEARCH_ITEMS: ConfigSearchItem[] = [
  ...
  },
  {
    ...
    section: "Mi operación",
    title: "Mesas",
    description: "Espacios, salas, mesas y distribución inicial.",
    href: CONFIG_ROUTES.tables,
    keywords: ["mesa", "mesas", "sala", "salas", "distribucion", "espacio"],
  },
  {
    id: "space-editor",
    section: "Mi operación",
    title: "Editor de espacios",
    description: "Plano visual, elementos y distribución del restaurante.",
    href: CONFIG_ROUTES.spaceEditor,
    keywords: ["editor", "plano", "espacio", "espacios", "elemento", "elementos"],
  },
  {
    id: "menu-categories",
    section: "Mi carta",
