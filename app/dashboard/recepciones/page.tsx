...
const CANONICAL_RECEIPTS_ROUTE = "/dashboard/inventario/pedidos-compra";
...
export default function RecepcionesPage() {
  ...
  useEffect(() => {
    ...
    void migrateLegacyPurchasesFromBrowser(rid)
      .then(() => router.replace(CANONICAL_RECEIPTS_ROUTE))
      .catch((migrationError) => {
        console.error("[recepciones] legacy migration failed", migrationError);
        setError(
          "No se han podido migrar las recepciones antiguas. Los datos locales se conservan y no se ha eliminado nada.",
        );
  ...
  return (
    <ModulePageShell title="Recepciones">
      <div
        style={{
          maxWidth: 720,
        ...
        {displayError ? (
          <>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
              ...
              <Link href={CANONICAL_RECEIPTS_ROUTE} className="hostly-button-secondary hostly-button-compact">
          ...
          <p style={{ margin: 0, color: "var(--hostly-ink-muted)" }}>
            Migrando cualquier recepción antigua de este dispositivo y abriendo el flujo canónico de pedidos y recepciones…
          </p>
        )}
      </div>
    </ModulePageShell>
