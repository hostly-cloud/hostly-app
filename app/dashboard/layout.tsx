...
export default function DashboardLayout({
  ...
  return (
    <div className="hostly-touch-root flex min-h-full flex-col" data-hostly-touch>
      <Suspense fallback={null}>
        <DashboardGate>
          <ConnectivityProvider>
            ...
            <HostlySection stack="lg" className="flex flex-1 flex-col items-center justify-center px-4 py-10 sm:px-6">
              <HostlySurface
                variant="ice"
              ...
              >
                ...
                <ul className="m-0 mb-8 flex list-none flex-col gap-2.5 border-t border-[var(--hostly-table-divider-faint)] pt-6 p-0">
                  {[t("onboarding.chkCatalogo"), t("onboarding.chkInventario"), t("onboarding.chkUsuarios")].map((label) => (
                    <li key={label} className="flex items-start gap-3 text-[13px] font-semibold text-[color:var(--hostly-ink)]">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                  <Link href="/dashboard/onboarding" className="hostly-button-primary inline-flex shrink-0 justify-center text-center no-underline">
