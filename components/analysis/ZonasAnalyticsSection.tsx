...
import { ZonasToolbar } from "@/components/analysis/ZonasToolbar";
    ...
    <>
      <div className="mt-6">
        {zoneMetrics.length === 0 ? (
          <p className="mb-3 text-sm text-[var(--hostly-ink-muted)]">Sin datos por zona</p>
        ) : (
          <ZonasKpiBlock data={zonasKpis} />
        )}

        <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
          <h3 className="mb-0 text-lg font-semibold">Rendimiento por zona</h3>
          <ZonasToolbar
            compactViewZonas={compactViewZonas}
            setCompactViewZonas={setCompactViewZonas}
            ordenZonas={ordenZonas}
            setOrdenZonas={setOrdenZonas}
            searchZona={searchZona}
            setSearchZona={setSearchZona}
            limitZonas={limitZonas}
            setLimitZonas={setLimitZonas}
            columnasZonas={columnasZonas}
            setColumnasZonas={setColumnasZonas}
            vistaDefaultZonas={vistaDefaultZonas}
            limpiarFiltrosVistaZonas={limpiarFiltrosVistaZonas}
            aplicarVistaDefaultZonas={aplicarVistaDefaultZonas}
            resetZonasPrefs={resetZonasPrefs}
            exportarZonas={exportarZonas}
            zoneMetricsLimited={zoneMetricsLimited}
            copiarResumenZonas={copiarResumenZonas}
          />
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr>
                  <td
                    className="py-4 text-sm text-[var(--hostly-ink-muted)]"
                    colSpan={zonasTableData.columnasZonasTablaCount}
                  >
                    Sin resultados
                  </td>
                </tr>
      ...
      {!compactViewZonas ? (
        <>
          <div className="hostly-panel mt-6 p-4">
            <div
              style={{
                fontSize: 13,
                fontWeight: 800,
            ...
            {zoneMetrics.length === 0 ? (
              ...
              >
                ...
                >
                  ...
                  <Bar
                    dataKey="total"
                    fill={analysisRechartsOnDark.barPrimary}
                    radius={[5, 5, 0, 0]}
                  />
                </BarChart>
              </ResponsiveContainer>
            ...
            {zoneMetrics.length === 0 ? (
              ...
              >
                ...
                >
                  ...
                  <Bar
                    dataKey="noShow"
                    fill={analysisRechartsOnDark.barAccent}
                    radius={[5, 5, 0, 0]}
                  />
                </BarChart>
              </ResponsiveContainer>
            ...
            {zoneMetrics.length === 0 ? (
              ...
              >
                ...
                >
                  ...
                  <Bar
                    dataKey="share"
                    fill={analysisRechartsOnDark.barSecondary}
                    radius={[5, 5, 0, 0]}
                  />
                </BarChart>
              </ResponsiveContainer>
