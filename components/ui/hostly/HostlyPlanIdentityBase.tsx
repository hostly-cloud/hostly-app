...
type HostlyPlanIdentityClassNames = {
  root?: string;
  compact?: string;
  emblem?: string;
  copy?: string;
...
function PlanEmblem({
  ...
  plan: HostlyPlan;
  classNames?: HostlyPlanIdentityClassNames;
}) {
  return (
    <span
      className={hostlyCx(classNames?.emblem, "hostly-plan-identity__emblem")}
      aria-hidden
    >
...
export function HostlyPlanIdentityBase({
  plan,
  label,
  ariaLabel,
  compact = false,
  ...
  return (
    ...
    >
      <PlanEmblem plan={plan} classNames={classNames} />
      <span
        className={hostlyCx(classNames?.copy, "hostly-plan-identity__copy")}
        aria-hidden
      >
        <span className={hostlyCx(classNames?.brand, "hostly-plan-identity__brand")}>
          Hostly
        </span>
        <span className={hostlyCx(classNames?.name, "hostly-plan-identity__name")}>
          {resolvedLabel}
        </span>
      </span>
    </span>
