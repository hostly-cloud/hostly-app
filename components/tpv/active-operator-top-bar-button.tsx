...
export function ActiveOperatorTopBarButton() {
  ...
  return (
    <button
      ...
      className="hostly-tpv-active-operator-btn inline-flex min-h-[36px] items-center gap-1.5 rounded-xl border border-[rgba(15,23,42,0.1)] bg-white px-3 py-2 text-sm font-semibold text-[var(--hostly-ink)] shadow-sm transition-colors hover:bg-[rgba(15,23,42,0.03)] touch-manipulation"
